...
export default function TeamChangeRequestsPage() {
  ...
  if (loading) {
    // Render the skeleton loader directly in the page component
    return (
      <AdminPageWrapper>
        <div className="space-y-6 p-4 sm:p-6 lg:p-8">
          ...
          <div className="text-center py-5">
            ...
            <div className="h-8 w-64 mx-auto mb-4 bg-accent animate-pulse" />
            <div className="h-5 w-96 mx-auto bg-accent animate-pulse" />
          </div>
            ...
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-5 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="h-4 w-24 mb-1 bg-accent animate-pulse" />
                    <div className="h-6 w-8 bg-accent animate-pulse" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid gap-5">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="overflow-hidden border-0 shadow-md rounded-xl bg-white">
                <div className="p-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <div className="h-6 w-40 mb-2 bg-accent animate-pulse" />
                        <div className="h-4 w-64 bg-accent animate-pulse" />
                      </div>
                    </div>
                    <div className="flex flex-wrap items-center gap-3">
                      <div className="h-8 w-20 rounded-full bg-accent animate-pulse" />
                      <div className="h-10 w-24 rounded-xl bg-accent animate-pulse" />
                    </div>
                  </div>
                </div>
                <div className="px-6 pb-6">
                  <div className="flex flex-wrap items-center justify-between gap-3 text-xs md:text-sm text-slate-600 bg-white/50 backdrop-blur-sm rounded-lg p-3">
                    <div className="flex items-center gap-1.5">
                      <div className="h-3.5 w-3.5 rounded-full bg-accent animate-pulse" />
                      <div className="h-4 w-40 bg-accent animate-pulse" />
                    </div>
                    <div className="flex items-center gap-1.5">
                      <div className="h-3.5 w-3.5 rounded-full bg-accent animate-pulse" />
                      <div className="h-4 w-48 bg-accent animate-pulse" />
                    </div>
                  </div>
